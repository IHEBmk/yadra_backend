...
class Company(db.Model):
    ...
    email = db.Column(db.String(132),unique=False,nullable=False)
    phone = db.Column(db.String(132),unique=False,nullable=True)
    description = db.Column(db.String(132),unique=False,nullable=False)
    website = db.Column(db.String(132),unique=False,nullable=False)
    business_registration = db.Column(db.String(132),unique=True,nullable=True)
    social_links = db.Column(db.String(132),unique=False,nullable=False)
    logo = db.Column(db.String(120),unique=False,nullable=False)
...
class Company_register(db.Model):
    ...
    logo = db.Column(db.String(500),unique=False,nullable=False)
    category=db.Column(db.Integer,ForeignKey('category.id'))
    address = db.Column(db.String(120),nullable=False)
    is_hidden = db.Column(db.Boolean, default=False)
...
class Review(db.Model):
    ...
    city = db.Column(db.String(120),nullable=True, default = 'Unknown')
    country = db.Column(db.String(120),nullable=True, default = 'Unknown')
